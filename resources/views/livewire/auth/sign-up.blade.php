<div class="sign__content">
    <form wire:submit.prevent='register' class="sign__form">
      <a href="/" class="sign__logo">
        <img src="{{ asset('public/assets/img/logo.png') }}" alt="">
      </a>

      <div class="sign__group">
        <input wire:model='first_name' type="text" class="sign__input" placeholder="First Name">
        @error('first_name')
      ...
      <div class="sign__group">
        <input wire:model='last_name' type="text" class="sign__input" placeholder="Last Name">
        @error('last_name')
      <p class="text-danger">{{ $message }}</p>
      @enderror
      </div>
      ...
      <div class="sign__group">
        <input wire:model='email' type="email" class="sign__input" placeholder="Email">
        @error('email')
      <p class="text-danger">{{ $message }}</p>
      @enderror
      </div>
      ...
      <div class="sign__group">
        <input wire:model='password' type="password" class="sign__input" placeholder="Password">
        @error('password')
      <p class="text-danger">{{ $message }}</p>
      @enderror
      </div>

      <div class="sign__group sign__group--checkbox d-none">
        <input id="remember" name="remember" type="checkbox" checked="checked">
        <label for="remember">I agree to the <a href="privacy.html">Privacy Policy</a></label>
      </div>
      
      <button class="sign__btn" type="submit">Sign up</button>
      <div wire:loading.inline wire:target="register">
        <h4 >Loading....</h4>
        </div>
      ...
      <span class="sign__text">Already have an account? <a href="/sign-in">Sign in!</a></span>
    </form>
  </div>
