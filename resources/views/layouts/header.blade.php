<header class="header">
  <div class="header__content">
    ...
    <nav class="header__nav">
      ...
      <a href="/dashboard/all-songs">All Songs</a>
      @endauth
...
<div class="header__action header__action--signin">
  <a class="header__action-btn" href="/sign-in">
    <span>Sign in</span>
...
<div class="header__action header__action--signin">
  <div class="profile__avatar">
    <img src="https://eu.ui-avatars.com/api/?background=random&amp;name={{ Str::ucfirst(auth()->user()->first_name) }} 
    {{ Str::ucfirst(auth()->user()->last_name) }}" alt="">
  </div>
